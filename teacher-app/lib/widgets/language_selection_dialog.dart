...
Future<void> showLanguageSelectionDialog(BuildContext context) async {
  ...
  final availableLanguages = localizationProvider.availableLanguages;
          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  context.tr('settings.language_dialog.title'),
            ...
            Text(
              context.tr('settings.language_dialog.subtitle'),
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  subtitle: (language['code'] == 'en')
                      ? Text('English', style: DSTypography.caption)
                      : (language['code'] == 'ar'
                            ? Text('العربية', style: DSTypography.caption)
                            : null),
                  trailing: isSelected
