...
class ApiService {
  ...
  // ✅ FIXED: Reset password method now uses resetToken instead of verificationCode
  static Future<Map<String, dynamic>> resetPassword({
    required String phoneNumber,
    required String resetToken,  // ✅ FIXED: Changed from verificationCode to resetToken
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          'phoneNumber': phoneNumber,
          'resetToken': resetToken,  // ✅ FIXED: Send resetToken instead of verificationCode
