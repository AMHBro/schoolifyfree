...
// Lightweight design system tokens adapted from education_design_system.json
// Primary brand color override per requirement
class DSColors {
  static const Color primary = Color(0xFF742FB5); // #742FB5
  // Extended palette aligned with education_design_system.json
  ...
  // Subject color rotation, deterministic per subject name
  static const List<Color> subjectPalette = <Color>[
    ...
    orange,
    charcoal,
    Color(0xFF8B5CF6), // original purple from JSON palette
  ];
}
  ...
  static ThemeData themeData(BuildContext context) {
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        toolbarHeight: 60,
        iconTheme: IconThemeData(color: DSColors.charcoal, size: 22),
        actionsIconTheme: IconThemeData(color: DSColors.charcoal, size: 22),
